...
@section('title', $app['name'] ?? '404 – Page Not Found')
@section('description', strip_tags(Illuminate\Support\Str::words($app['description'],30)) ?? '')
@section('content')
    <div class="block_left col-sm-9 col-xs-12">
        ...
        @if(isset($app['name']))
            <div class="block_product_detail">
                <div class="block block_commom block_shadow">
                    <div class="block_title">
                        <div class="block_breadcrumb">
                            <ul class="breadcrumb">
                                <li><a href="{{ route('site.index') }}">{{__('web.home')}}</a></li>
                                <li>
                                    <a href="{{route('site.category', [$app['category']['id']]) }}">{{$app['category']['name']}}</a>
                                </li>
                ...
                <div class="product_box">
                    <div class="row">
                        ...
                        <div class="col-sm-9 pro_detail_info">
                            ...
                            <div class="pro_detail_version">
                                <div class="table-responsive">
                                    <table class="table table-no-border">
                                        ...
                                        <tr>
                                            <td><a href="#" title="">{{$app['developer']['name']}}.</a></td>
                            ...
                            <div class="clearfix">
                                <div class="down_btn">
                                    <a target="_blank" href="{{route('site.download', [str_slug($app['name'], '-'), $app['id']])}}" class="btn btn_down"  title="Download {{$app['name']}}">
                                        {{__('web.installapk')}}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product_box">
                            <div class="clearfix block_faq">
                                <div class="box-header accordion-header text-center">
                                    <div class="fast-download-box fast-top">
                                        <h1>Downloading <i class="fa fa-spinner fa-spin"
                                                           style="font-size: 30px;color: #DE4C34"></i></h1>
                                        <p>Downloading {{$app['name']}} {{$app['id']}}.apk</p>
                                        <p><a rel="nofollow" href="{{route('site.downloading', [$app['id']])}}">If the
                                                download doesn't start, click here</a></p>
                                    </div>
                                </div>
                            </div>
                        </div><!-- /product_box -->
                ...
                <div class="block">{!! $ad['above_download_page'] !!}</div>
                <div class="product_box">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <p><a title="Download more Role Playing games"
                                      href="#"><span>{{$app['category']['name']}}</span></a></p>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <p>@php echo date('d/m/Y',$app['releasedTimestamp'])@endphp</p>
                            </div>
                        </div>
                    </div>
                </div><!-- /product_box -->
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="rating-block">
                                    ...
                                    <h2 class="bold padding-bottom-7">{{round($app['score'],1)}} <small>/ 5</small></h2>
...
@section('scripts')
    <script>
        $(document).ready(function () {
            window.location.href = '{{route('site.downloading', [$app['id']])}}'
        });
    </script>
@endsection
