                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 pro_detail_info">
                                    ...
                                    <div class="clearfix">
                                        <div class="down_btn">
                                            <a target="_blank"
                                               href="{{route('site.download', [str_slug($app['name'], '-'), $app['id']])}}"
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <p><a title="Download more Role Playing games"
                                              href="{{route('site.category', [$app['category']['id']])}}"><span>{{$app['category']['name']}}</span></a>
                                            <meta itemprop="applicationCategory"
                                                  content="{{$app['category']['name']}}"/>
                                        </p>
                                    </div>
                                    <div class="col-sm-3">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="rating-block" itemprop="aggregateRating" itemscope
                                    ...
                                    <h2 class="bold padding-bottom-7" itemprop="ratingValue">{{round($app['score'],1)}}
                                        <small>/ 5</small></h2>
