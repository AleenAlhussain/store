        ...
        <div class="block block_products block_commom">
            <div class="block_title">
                <div class="block_breadcrumb">
                    <ul class="breadcrumb">
                        <li><a href="{{ route('site.index',app()->getLocale()) }}">{{__('web.home')}}</a></li>
                        <li><a href="{{ route('site.toppic',app()->getLocale()) }}">{{ __('web.Toppic') }}</a></li>
                            ...
                            <li class="col-sm-5ths col-xs-6">
                                <div class="product_item">
                                    <div class="product_img">
                                        <a title="{{$top['title']}}"
                                           href="{{ route('site.detail', [$top['slug'],$top['appid']]) }}">
                                            <img alt="{{$top['title']}}"
                                    ...
                                    <div class="description">
                                        <h3>
                                            <a title="{{$top['title']}}"
                                               href="{{ route('site.detail', [$top['slug'],$top['appid']]) }}">{{$top['title']}}</a>
                                        </h3>
                                        <div class="stars">
                                        ...
                                        <div class="down_btn">
                                            <a href="{{ route('site.detail', [$top['slug'],$top['appid']]) }}"
