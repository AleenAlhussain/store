...
<head>
    ...
    <link rel="canonical" href="{{$html_links}}" />
    ...
    <script type="application/ld+json">
        {
            ...
            "potentialAction": {
                "@type": "SearchAction",
                "target": "{{url('/')}}/en/search?q={search_term_string}",
        ...
        <div class="container">
            ...
            <div class="block_menu_top">
                ...
                <ul class="nav_menu">
                    ...
                    <li class="nav_menu_item">
                        <a title="hot game" href="{{ route('home.toppic',app()->getLocale()) }}"><i class="fa fa-archive"
                    ...
                    <li class="nav_menu_item parent">
                        <a title="select country" href="javascript:void(0);"><i class="fa fa-globe"
                                                                                style="font-size:20px;color:#ec2c3e"></i> {{$languages[app()->getLocale()]}}
                        </a>
                        <ul class="nav_submenu">
                            @foreach($translations as $row)
                                @if($row->locale_code !=$country)
                                    <li>
