                ...
                <div class="product_box">
                    <div class="row">
                        ...
                        <div class="col-sm-9 pro_detail_info">
                            ...
                            <div class="clearfix">
                                <div class="down_btn">
                                    <a target="_blank" href="{{route('home.download', [app()->getLocale(),str_slug($app['name'], '-'), $app['id']])}}" class="btn btn_down"  title="Download {{$app['name']}}">
                                        {{__('web.installapk')}}
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="clearfix block_faq">
                                <div class="box-header accordion-header text-center">
                                    <div class="fast-download-box fast-top">
                                        ...
                                        <p><a rel="nofollow" href="{{route('home.downloading', [app()->getLocale(),$app['id']])}}">If the
...
@section('scripts')
    <script>
        $(document).ready(function () {
            window.location.href = '{{route('home.downloading', [app()->getLocale(),$app['id']])}}'
        });
    </script>
@endsection
