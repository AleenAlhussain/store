...
<head>
    ...
    <title>Application have been removed</title>
    ...
    <link type="text/css" rel="stylesheet"
          href="{{ asset('public/theme/css/font-awesome.min.css') }}"/>

    <link type="text/css" rel="stylesheet" href="{{ asset('public/theme/css/error.css') }}"/>
...
<div id="notfound">
    <div class="notfound">
        ...
        <h2>Application have been removed</h2>
