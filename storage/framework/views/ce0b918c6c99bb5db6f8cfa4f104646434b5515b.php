                                    ...
                                    <li class="col-sm-4 col-xs-6 product_item">
                                        <div class="product_img">
                                            <a title="<?php echo e($top['title']); ?>"
                                               href="<?php echo e(route('site.detail', [$top['slug'], $top['id']])); ?>">
                                        ...
                                        <div class="description">
                                            <h3>
                                                <a title="<?php echo e($top['title']); ?>"
                                                   href="<?php echo e(route('site.detail', [$top['slug'], $top['id']])); ?>"><?php echo e($top['title']); ?></a>
                                            </h3>
                                            <div class="stars">
                                    <span title="<?php echo e($top['title']); ?> average rating <?php echo e($top['score']); ?>"
                                          style="width:<?php echo e((((int)$top['score'] / 5) * 100)); ?>%;"></span>
                                            ...
                                            <div class="down_btn">
                                                ...
                                                <a href="<?php echo e(route('site.detail', [$top['slug'], $top['id']])); ?>"
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hadiabouammar/Documents/GitHub/store/resources/views/site/index.blade.php ENDPATH**/ ?>