...
<head>
    ...
    <link type="text/css" rel="stylesheet"
          href="<?php echo e(asset('public/theme/css/font-awesome.min.css')); ?>"/>

    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('public/theme/css/error.css')); ?>"/>
...
<div id="notfound">
    <div class="notfound">
        ...
        Try searching again, or explore more Android Games and Apps below!</p>
        <p><a
                    href="<?php echo e(url('/')); ?>">Return to homepage</a></p>
    </div>
</div>
</body>
</html>
<?php /**PATH /Users/hadiabouammar/Documents/GitHub/store/resources/views/errors/404.blade.php ENDPATH**/ ?>