...
<head>
    ...
    $repace = url('/');
    $count = strlen(url('/')) + 3;
    $find = substr($url, 0, $count);
    $html_links = str_replace($find, $repace, $url);?>
    <link rel="canonical" href="<?php echo e($html_links); ?>" />
    ...
    <script type="application/ld+json">
        {
            ...
            "potentialAction": {
                "@type": "SearchAction",
                "target": "<?php echo e(url('/')); ?>/en/search?q={search_term_string}",
    ...
    <header class="block header fixed">
        <div class="container">
            <div class="block_logo">
                <a href="<?php echo e(route('home.index',app()->getLocale())); ?>" title="<?php echo e($site['site_title']); ?>">
                    <img alt="<?php echo e(config('app.name', 'Laravel')); ?>" src="<?php echo e(asset('public/theme/images/logo.png')); ?>">
                </a>
            </div><!-- /block-logo -->
            <div class="block_search_top">
                <div class="block_search">
                    <form action="<?php echo e(route('home.search',app()->getLocale())); ?>" method="GET" class="form_search">
            ...
            <div class="block_menu_top">
                ...
                <ul class="nav_menu">
                    <li class="nav_menu_item">
                        <a title="hot game" href="<?php echo e(route('home.index',app()->getLocale())); ?>"><i class="fa fa-home"
                                                                                style="font-size:20px;color:#ec2c3e"></i> <?php echo e(__('web.home')); ?>

                        </a>
                    </li>
                    <li class="nav_menu_item">
                        <a title="hot game" href="<?php echo e(route('home.toppic',app()->getLocale())); ?>"><i class="fa fa-archive"
                    ...
                    <li class="nav_menu_item parent">
                        <a title="select country" href="javascript:void(0);"><i class="fa fa-globe"
                                                                                style="font-size:20px;color:#ec2c3e"></i> <?php echo e($languages[app()->getLocale()]); ?>
                        ...
                        <ul class="nav_submenu">
                            <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($row->locale_code !=$country): ?>
                                    <li>
                                        <a href="<?php echo e(route('home.lang', [$row->code,$row->locale_code])); ?>"><?php echo e($row->language); ?></a>
                                    </li>
                                <?php endif; ?>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="Game">
                                    ...
                                    <div class="block_more"><a
                                                href="<?php echo e(route('home.top', [app()->getLocale(),'games'])); ?>"><?php echo e(__('web.more')); ?> »</a>
                                    </div>
                                </div><!-- Game -->
                                <div role="tabpanel" class="tab-pane" id="Apps">
                                    ...
                                    <div class="block_more"><a
                                                href="<?php echo e(route('home.top', [app()->getLocale(),'apps'])); ?>"><?php echo e(__('web.more')); ?> »</a>
                                    </div>
                                </div><!-- Apps -->
                            ...
                            <?php if(count($pages)>0): ?>
                                <ul>
                                    <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a href="<?php echo e(route('home.page', [app()->getLocale(),$r->slug])); ?>"
...
<script type='text/javascript'>
    $(document).ready(function () {
        ...
        function load_data(key = "", val = '', _token) {
            ...
            $.ajax({
                url: "<?php echo e(route('ajax.getData',app()->getLocale())); ?>",
                method: "POST",
...
<?php /**PATH /Users/hadiabouammar/Documents/GitHub/store/resources/views/layouts/main.blade.php ENDPATH**/ ?>